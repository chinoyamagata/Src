...
#define	imTMPDw_VolModel		-50			/* 電圧下限値_-0.050Vdc */
#define	imTMPUp_VolModel		8050		/* 電圧上限値_8.050Vcd */
#define	imTMPDw_PulseModel		0			/* パルス下限値_0cnt */
#define	imTMPUp_PulseModel		8000		/* パルス上限値_8000cnt */
...
/* センサユニット測定異常 */
#define	imComUp_Sensor			32767		/* 上限オーバー */
#define	imComDw_Sensor			-32767		/* 下限オーバー */
#define	imComHard_Sensor		-32765		/* ハード異常 */
#define	imComBurn_Sensor		32766		/* バーンアウト */
...
/* 電圧測定異常 */
#define	imComUp_VolModel		32767		/* 電圧測定で上限オーバー */
#define	imComDw_VolModel		-32767		/* 電圧測定で下限オーバー */
#define imComHard_VolModel		-32765		/* ハード異常 */

/* パルス測定異常 */
#define	imComUp_PulseModel		32767		/* パルス測定で上限オーバー */
#define	imComDw_PulseModel		-32767		/* パルス測定で下限オーバー */
#define imComHard_PulseModel	-32765		/* ハード異常 */
#endif
...
#define	imAlmValDw_VolModel 	 0		/* 電圧_0.0Vdc */
#define	imAlmValUp_VolModel 	 8000		/* 電圧_8.000Vdc */
#define	imAlmValDw_PulseModel	 0		/* パルス_0cnt */
#define	imAlmValUp_PulseModel	 8000		/* パルス_8000cnt */
