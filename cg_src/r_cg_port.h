...
Macro definitions
***********************************************************************************************************************/
#define _38_PM2_DEFAULT         (0x38U) /* PM2 default value */
#define _F0_PM3_DEFAULT         (0xF0U) /* PM3 default value */
#define _C2_PM4_DEFAULT         (0xC2U) /* PM4 default value */
#define _63_PM5_DEFAULT         (0x63U) /* PM5 default value */
#define _FC_PM6_DEFAULT         (0xFCU) /* PM6 default value */
#define _0E_PM7_DEFAULT         (0x0EU) /* PM7 default value */
#define _1F_PM12_DEFAULT        (0x1FU) /* PM12 default value */
#define _F0_PMC1_DEFAULT        (0xF0U) /* PMC1 default value */
#define _3B_PMC2_DEFAULT        (0x3BU) /* PMC2 default value */
...
extern void R_PORT_BattCtrlOnOff( uint8_t arOnOff );
