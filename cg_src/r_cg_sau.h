...
#define _3A00_IIC00_DIVISOR 			 (0x3A00U)
#define IIC00_WAITTIME					 (10U) /* change the waiting time according to the system */
...
extern void R_UART2_SndStart( void );											/* 通信ポート送信開始 */
extern void R_UART2_SndStop( void );											/* 通信ポート送信停止 */
extern void R_UART2_RcvStart( void );											/* 通信ポート受信開始 */
extern void R_UART2_RcvStop( void );											/* 通信ポート受信停止 */
